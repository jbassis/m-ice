...
fname = fname_base + str(20).zfill(3)+'.npz'
print(fname)
...
cbar2.set_ticks([-8,-5])
cbar2.set_ticklabels([r'$10^{-8}$',r'$10^{-5}$'])
cbar2.set_label('$\dot \epsilon_{II}$ (s$^{-1}$)',fontsize=12)
...
fname = fname_base + str(250).zfill(3)+'.npz'
print(fname)
...
#fname = 'Figures/super_buoyancy.pdf'
#plt.savefig(fname)
