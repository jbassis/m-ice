...
plot_term_buttressing(ax10,fname1=fname1,fname2=fname2,fname3=fname3,fname4=None,fname5=None,tmax=270)

#data=np.load(fname6)
#ax10.plot(data['t']*365,(data['L']-4800)/1e3,'-.',color='#009E73')
#data=np.load(fname7)
#ax10.plot(data['t']*365,(data['L']-9600)/1e3,'-.',color='#D55E00')
plt.xticks([0,90,180,270],['day 0', 'day 90','day 180', 'day 270'])
#plt.yticks([-2,0.25])
...
ax11 = fig.add_subplot(gs[1,0:3])
plot_term_buttressing(ax11,fname1=None,fname2=None,fname3=None,fname4=fname4,fname5=None,tmax=180)
data5=np.load(fname2)
ax11.plot(data5['t']*365,(data5['L']-4800)/1e3,'-',color='#009E73',linewidth=2)
data=np.load(fname6)
ax11.plot(data['t']*365,(data['L']-4800)/1e3,'-.',color='#009E73')
plt.xticks([0,90,180],['day 0', 'day 90', 'day 180'])
plt.yticks([-2,0.25])
#plt.text(36,-0.7,'25 kPa',color='#009E73',fontsize=10,fontweight='bold')
#plt.text(24,-1.9,'buttressing on',color='#009E73',fontsize=10,fontweight='bold')
#plt.text(35,-1.9,'25 kPa',fontsize=10)
plt.text(95,-0.5,'buttressing off',fontsize=10)

#plt.text(10,-0.12,'buttressed',fontsize=10)
#plt.text(100,-0.12,'unbuttressed',fontsize=10)
...
#plt.text(-20,-1.25,'buttressing on',fontsize=10)
plt.text(95,-1.9,'buttressing off',fontsize=10)
